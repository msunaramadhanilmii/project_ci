...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
      $config = [
        ...
        'smtp_user' => 'project.msunaramadhanilmi@gmail.com',
      ...
      $this->email->from('project.msunaramadhanilmi@gmail.com', 'Project Muhammad Suna Ramadhan Ilmi');
      ...
      if($user) { 
        ...
        if($user_token) {
          if(time() - $user_token['date_created'] < (60 * 60 * 24)) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">' . $email . ' your account has been activated!</div>');
            redirect('auth');
          } else {
    ...
    public function forgotPassword()
    {
      ...
      if($this->form_validation->run() == false) {
        ...
        if($user) {
          ...
          $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Please check your email to reset your account!</div>');
